...
```bash
pip install numpy pandas xgboost scikit-learn shap rasterio geopandas osmium \
  folium matplotlib seaborn openpyxl netcdf4 xarray fiona pyproj scipy networkx
```
...
│   ├── test_pipeline.py                # 251 assertions across 18 categories
...
│       ├── relocation_sites.csv / .json      # Site register (12,211 canonical-GREEN, 446 ideal)
│       ├── vyoma_export_all_states.json / vyoma_sites_export_all_states.json
│       │                                     # Full 7-state frontend export (43,996 villages / 12,211 sites)
│       └── vyoma_export_mizoram.json / vyoma_sites_export_mizoram.json
│                                             # Mizoram test fixture (830 villages / 53 sites)
```
...
### Test Suite: 251 Assertions Across 18 Categories
...
| Susceptibility Model (Phase 1) | 9 | ✅ |
| Carrying Capacity (Phase 2) | 7 | ✅ |
| Relocation Planner (Phase 3) | 15 | ✅ |
| Social Vulnerability (Phase 4) | 11 | ✅ |
| Hazard Decomposition (Phase 5) | 13 | ✅ |
| Slope Correction | 3 | ✅ |
| Tie-Break Regression | 1 | ✅ |
